...
{
    public class OfficialAccount_ViewModel
    {
    ...
    public class OfficialAccount_BaseInfo_ViewModel
    {
        public System.Guid AccountID { get; set; }
    ...
    public class OfficialAccount_YouZan_ViewModel
    {
        public System.Guid AccountID { get; set; }
    ...
    public class OfficialAccount_Score_ViewModel
    {
        public System.Guid AccountID { get; set; }
    ...
    /// 账号信息完成度
    /// </summary>
    public class OfficialAccount_Finish_ViewModel
    {
    ...
    public class OfficialAccount_AreaLimit_ViewModel
    {
        public Guid AccountID { get; set; }
        [Required]
        [Display(Name = "区域")]
